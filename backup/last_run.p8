...
powerup_type   = 0  -- 1=3 extra balls, 2=れ❎2 score
...
function update_extra_balls()
  for i=#extra_balls,1,-1 do
    ...
    if eb.life<=0 then
      ...
      -- collision with player's paddle => +1 れ❎mult
      ...
      -- collision with AI or pass AI => +3 れ❎mult if it passes
      if eb.x+2>ai.x then
...
function spawn_bubble()
  ...
  -- random spawn in るね10px around center so it doesn't get auto-popped
